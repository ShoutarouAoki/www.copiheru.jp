...
if(empty($exection)){
	...
	************************************************/
	...
	# USE
		...
		# CHARA DATA 取得
		$character_data									= $memberModel->getMemberDataById($character_id,NULL,"naruto");
						...
						************************************************/
						...
						if(empty($error)){
							...
							************************************************/
								...
								# 有効期限チェック OK
								if($items_data['limit_date'] >= date("YmdHis")){//20170919 update by A.cos
								//if($items_data['end_date'] >= date("YmdHis")){
									
									$limit_time			= $items_data['limit_date'];//20170919 update by A.cos
