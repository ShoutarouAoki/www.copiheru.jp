			...
			if($rows == 0){
				...
				# 処理OK
					...
					if(!empty($resurrection)){
						...
						$send_update_conditions[':send_id']			= $result['id'];
						$send_update_conditions[':send_del_flg']	= 8;
						...
						$recv_update_conditions[':recv_id']			= $result['id'];
						$recv_update_conditions[':recv_del_flg']	= 8;
