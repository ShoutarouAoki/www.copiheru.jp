...
function constructDefine(send_id,parent_id,mail_id,before_id,item_check,colorbox,point_s,point_r,point_i,user_status,sleep_flg,ticket,send,more,event_id) {
...
function checkSleep() {
	if(!num_atap){
		...
		$.ajax({
			...
			url: "/eventmail/sleep/",
			dataType: 'json',
			data : {id : post_send_id, sleep : sleep, event_id : post_event_id },
			timeout:10000,
			cache: false,
			// 通信成功
...
function checkNewMessage() {
	...
	if(!num_atap){
		...
		$.ajax({
			type:'POST',
			url: "/eventmail/check/",
			data : {id : post_id, last_mail_id : last_mail_id, event_id : post_event_id  },
			timeout:10000,
			cache: false,
			// 通信成功
...
function getItemList(device) {
	...
	$.ajax({
		type: "POST",
		url: "/item/mail/",
		data : {id : post_send_id, event_id : post_event_id },
		timeout:10000,
		cache: false,
		// 成功
		success: function(html){
...
function itemUse(item_id,item_count) {
	...
	if (item_id && item_count) {
		...
		$.ajax({
			...
			url: "/item/use/",
			dataType: 'json',
			data : {id : post_send_id, itembox_id : item_id, sender : sender, event_id : post_event_id },
			timeout:10000,
			cache: false,
			// 通信成功
			success: function(data) {
...
function getItemUsingData(itembox_id) {
	...
	if (itembox_id) {
		...
		$.ajax({
			...
			url: "/item/using/",
			dataType: 'json',
			data : {id : post_send_id, itembox_id : itembox_id, event_id : post_event_id },
			timeout:10000,
			cache: false,
			// 通信成功
			success: function(data) {
...
function imageRead(mails_image_id) {
	...
	if (mails_image_id) {
		...
		$.ajax({
			...
			url: "/eventmail/image/",
			dataType: 'json',
			data : {id : post_send_id, mails_image_id : mails_image_id, event_id : post_event_id },
			timeout:10000,
			cache: false,
			// 通信成功
			success: function(data) {
...
function mailRead(mails_id,image_check) {
	...
	if (mails_id) {
		...
		$.ajax({
			...
			url: "/eventmail/read/",
			dataType: 'json',
			data : {id : post_send_id, first_mail : first_mail, mails_id : mails_id, image_check : image_check, confirmation : confirmation, event_id : post_event_id },
			timeout:10000,
			cache: false,
			// 通信成功
			success: function(data) {
...
function mailSend() {
	...
	$.ajax({
		...
		url: "/eventmail/send/",
		dataType: 'json',
		data : {id : post_send_id, first_mail : first_mail, message : message, confirmation : confirmation, event_id : post_event_id },
		timeout:10000,
		cache: false,
		// 通信成功
		success: function(data) {
